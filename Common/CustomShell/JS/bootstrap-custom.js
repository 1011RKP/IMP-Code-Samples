jQuery(document).ready(function ($) {
    ...
    /*Move suite bar links to ribbon*/
    ...
    /*var ribbonTabHeader = $('#header');*/
    var ribbonTabHeader = $('#RibbonContainer-TabRowRight');
    ribbonTabHeader.prepend(suiteBarButtons);
    ribbonTabHeader.prepend(welcomeMenuBox);
    ribbonTabHeader.prepend(suiteButtons);

    /*Hide Question mark icon*/
    //var hideImage = findFirstDescendant("ms-help", "img");

...
var siteownerCtrl = function (dataService) {  
    ...
    siteownerApp.component('siteOwner', {
        templateUrl: '/sites/common/SiteAssets/Dept_Compliance/siteOwner/HTML/WidgetTemplate/soTemplate.html',
        controllerAs: "model",
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (attachments.results.length > 0) {
                        ...
                        var url = attachments.results[0].ServerRelativeUrl;
                        ...
                        //console.log()
                        //$(".bannerImg").append("<img class=\"img-responsive banner\"  src=" + url + " />");
                    }

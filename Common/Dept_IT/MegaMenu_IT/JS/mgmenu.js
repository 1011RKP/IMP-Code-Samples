...
function ShowDepartmentsSubMenuItems(id) {
...
function OpenMenuItemsonHamburgerClick() {
    var ul = $('.mgmenuXS');
...
function ChangeanchortagTextColor(id) {
    $(id).find('.TopMenuTitle').css('color', 'white')
...
function ChangeSpantoBlue(id) {
    $(id).find('.TopMenuTitle').css('color', '#2aace3')
}
